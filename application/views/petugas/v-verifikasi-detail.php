      ...
      <div class="col-md-12">
        <form method="post" action="<?php echo base_url('masyarakat/postedit') ?>">
          ...
          <div class="form-group mt-3 text-center">
            ...
            <a href="<?php echo base_url('petugas/proses/'.$pengaduan[0]['id']) ?>" class="btn btn-success col-md-3 mb-2">Proses</a>  
            <a href="<?php echo base_url('petugas/detail_tanggapan/'.$pengaduan[0]['id']) ?>" class="btn btn-primary col-md-3 mb-2">Proses & Tanggapi</a>  
            <a href="<?php echo base_url('petugas/tolak/'.$pengaduan[0]['id']) ?>" class="btn btn-danger col-md-3 mb-2">Tolak</a>  
