...
class Admin extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-index', $data);
	...
	public function verifikasi()
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-verifikasi', $data);
		$this->load->view('komponen/komponen-admin/kom-footer');
	...
	public function verifikasi_detail($id)
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-verifikasi-detail', $data);
		$this->load->view('komponen/komponen-admin/kom-footer');
	...
	public function proses($id)
	{
		...
		return redirect(base_url('admin/verifikasi'));
	...
	public function proses_tanggapi($id)
	{
		...
		return redirect(base_url('admin/tanggapan/'.$id));
	...
	public function tanggapan()
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-tanggapan', $data);
		$this->load->view('komponen/komponen-admin/kom-footer');
	}
	...
	public function detail_tanggapan($id)
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-detail-tanggapan', $data);
		$this->load->view('komponen/komponen-admin/kom-footer');
	...
	public function posttanggapan()
	{
		...
		return redirect(base_url('admin/tanggapan'));
	}
	...
	public function data_pengaduan($filter)
	{
		...
		$this->load->view('komponen/komponen-admin/kom-sidebar');
		$this->load->view('komponen/komponen-admin/kom-navbar');
		$this->load->view('admin/v-data-pengaduan', $data);
		$this->load->view('komponen/komponen-admin/kom-footer');
